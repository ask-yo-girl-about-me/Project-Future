...
Das zweite Scritp erstellt zuerst den Ubuntu-Benutzer "future". Dieser ist in Mitglied der Group "User" und "Admin". Der Zugriff des User erfolgt mittels SSH-Key.
Danach werden die Ubunut Packete für den "LAMP" (Linux,Apache,MySQL,PHP)[^1] Stacks installiert. Danach wir noch ein SQL User erstellt und der MySQL-Server wird konfiguiert.
...
[Nächstes Lernziel BE4](https://github.com/ask-yo-girl-about-me/Project-Future/blob/main/02_Automatisierung/BE4.md)
